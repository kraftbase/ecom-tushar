		...
		<Container asChild>
			<nav className={cn("absolute h-[5.5rem] flex items-center")}>
				<div className="w-full flex items-center justify-between ">
					...
					<ul className="hidden lg:flex items-center justify-center text-[14px] px-3 text-foreground border border-white/10 rounded-full">
					...
					<Link href="#footer">
						<Button className="hidden relative lg:flex items-center justify-center gap-2 overflow-hidden glow-button-background ">
							Get Started
